...
def _is_typing_a_word(text: str, tokens) -> bool:
    # vrai si le texte finit par une lettre/apostrophe ET le dernier token va jusqu'à la fin
...
def analyze(text: str, lang: str = "fr") -> dict:
    ...
    return {"issues": issues, "next_word": next_word, "autocomplete": autocomplete}
